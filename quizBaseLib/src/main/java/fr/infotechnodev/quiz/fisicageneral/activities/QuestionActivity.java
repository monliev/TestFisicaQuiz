...
import fr.infotechnodev.quiz.fisicageneral.activities.questions.QuestionFragment;
import fr.infotechnodev.quiz.fisicageneral.activities.questions.QuestionPagerAdapter;
import fr.infotechnodev.quiz.fisicageneral.animations.GrowingViewRunnable;
...
import fr.infotechnodev.quiz.fisicageneral.views.MyAutoScrollViewPager;
...
public abstract class QuestionActivity extends BaseActivity implements OnPageChangeListener {
    ...
    public static final String KEY_QUESTION_LIST = "fr.infotechnodev.quiz.fisicageneral.activities.QuestionActivity.KeyQuestionList";
    public static final String KEY_GAMERULES = "fr.infotechnodev.quiz.fisicageneral.activities.QuestionActivity.KeyGameRules";
