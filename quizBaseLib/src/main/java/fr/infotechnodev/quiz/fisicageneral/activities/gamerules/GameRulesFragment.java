package fr.infotechnodev.quiz.fisicageneral.activities.gamerules;
...
import fr.infotechnodev.quiz.fisicageneral.views.CardViewPagerIndicator;

public class GameRulesFragment extends Fragment {

    private static final String TAG = GameRulesFragment.class.getName();

    public static String KEY_GAMERULES = "fr.infotechnodev.quiz.fisicageneral.activities.gamerules.GameRulesFragment.KeyGameRules";
    public static String KEY_INDEX = "fr.infotechnodev.quiz.fisicageneral.activities.gamerules.GameRulesFragment.KeyIndex";
    public static String KEY_ELEMENTS = "fr.infotechnodev.quiz.fisicageneral.activities.gamerules.GameRulesFragment.KeyElements";
