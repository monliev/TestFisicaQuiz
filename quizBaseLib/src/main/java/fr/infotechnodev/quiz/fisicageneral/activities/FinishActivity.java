...
public abstract class FinishActivity extends BaseActivity {
    ...
    public static final String KEY_QUESTION_POINTS = "fr.infotechnodev.quiz.fisicageneral.activities.FinishActivity.KeyQuestionPoints";
    public static final String KEY_GAMERULES = "fr.infotechnodev.quiz.fisicageneral.activities.FinishActivity.KeyGameRules";
