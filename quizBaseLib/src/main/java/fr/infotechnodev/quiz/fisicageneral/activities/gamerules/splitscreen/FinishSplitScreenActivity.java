...
import fr.infotechnodev.quiz.fisicageneral.views.RotatingLinearLayout;
...
public class FinishSplitScreenActivity extends FinishActivity {
    ...
    public static final String KEY_QUESTION_POINTS_2 = "fr.infotechnodev.quiz.fisicageneral.activities.FinishSplitScreenActivity.KeyQuestionPoints2";
